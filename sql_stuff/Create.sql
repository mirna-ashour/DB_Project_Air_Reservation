...
Status			varchar(255) NOT NULL,
	FOREIGN KEY (Airline_name) REFERENCES Airline(Name),
	FOREIGN KEY (Departure_airport_ID, Arrival_airport_ID) REFERENCES Airport(Airport_ID),
...
FOREIGN KEY (Airline_name, Flight_num, Departure_time, Departure_date) REFERENCES Airline(Name, Flight_num, Departure_time, Departure_date),
);
...
CREATE TABLE Buys (
	Ticket_ID 		int, 
Email 			varchar(255),
FOREIGN KEY (Ticket_ID, Email) REFERENCES Ticket(Ticket_ID, Email),
...
FOREIGN KEY (EmailAirline_name, Flight_num, Departure_time, Departure_date) REFERENCES Customer(Email, Name, Flight_num, Departure_time, Departure_date),
	PRIMARY KEY (Email, Name, Flight_num, Departure_time, Departure_date)
);
